...
drawJumpingObject = (randColor = colorArray[randomColor]) => {
    ctx.globalAlpha = 0.4;
    ctx.fillStyle = randColor;
    ctx.rect(500, 170, 60, 140)
    ctx.fill();
    ctx.closePath();
    ctx.beginPath();
    ctx.globalAlpha = 1;
    ctx.fillStyle = randColor;
    ctx.rect(500, 305, 60, 60)
    ctx.fill();
    ctx.closePath();
}

drawSlidingObject = (randColor = colorArray[randomColor]) => {
    ctx.beginPath();
    ctx.globalAlpha = 0.4;
    ctx.fillStyle = randColor;
    ctx.rect(500, 290, 60, 75)
    ctx.fill();
    ctx.closePath();
    ctx.beginPath();
    ctx.globalAlpha = 1;
    ctx.fillStyle = randColor;
    ctx.rect(500, 170, 60, 120)
    ctx.fill();
    ctx.closePath();
}

drawDivinggObject = (randColor = colorArray[randomColor]) => {
    ctx.beginPath();
    ctx.globalAlpha = 0.4;
    ctx.fillStyle = randColor;
    ctx.rect(500, 200, 60, 130)
    ctx.fill();
    ctx.closePath();
    ctx.beginPath();
    ctx.fillStyle = randColor;
    ctx.globalAlpha = 1;
    ctx.rect(500, 325, 60, 40)
    ctx.fill();
    ctx.closePath();
    ctx.beginPath();
    ctx.globalAlpha = 1;
    ctx.fillStyle = randColor;
    ctx.rect(500, 170, 60, 40)
    ctx.fill();
    ctx.closePath();
}
...
window.onload = function() {
    ...
    function loop() {
        ...
        drawCharacter();
        drawFloor();
        // drawSlidingObject(randColor);
        drawJumpingObject(randColor);
        // drawDivinggObject(randColor);
    }
    loop();
    checkInput();
}
